          ...
          <View>
            <View style={styles.mapContainer}>
              <MapView
                ...
                initialRegion={{
                  latitude:
                    places == undefined ? 60.201373 : places[0].latitude,
                  longitude:
                    places == undefined ? 24.934041 : places[0].longitude,
              ...
              >
                {places.map((marker, index) => (
                  <Marker
                    key={index}
                    coordinate={{
                      latitude: places == null ? 0 : marker.latitude,
                      longitude: places == null ? 0 : marker.longitude,
                    }}
